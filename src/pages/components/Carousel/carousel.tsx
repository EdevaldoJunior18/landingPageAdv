...
export default function Carousel({ images }: CarouselProps) {
    ...
    return (
        <div className="relative w-full mx-auto">
                    ...
                    {images.map((image, index) => (
                        <div key={index} className="min-w-full m-0 p-0">
                            <img
                                src={image}
                                alt={`Slide ${index + 1}`}
                                className="w-full h-[25vh] sm:h-[32vh] md:h-[39vh] lg:h-[46vh] object-cover block border-none"
            ...
            <div className="absolute bottom-2 sm:bottom-4 left-1/2 -translate-x-1/2 flex justify-center space-x-2 w-full">
